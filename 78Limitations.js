...
// if we have 1 million users then the two methods we defiend and assigned in our function will be created for 1 milliom user 
// :. we do : 
const userMethods = {
  about() {
    return `${this.firstName} is ${this.age} years old `;
...
// we still have a issue in our code 
